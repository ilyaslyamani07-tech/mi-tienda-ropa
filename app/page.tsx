...
export default function Home() {
  ...
  // Mostrar el popup a los 2 segundos de entrar
  useEffect(() => {
  ...
  const handleRevealCode = (e: React.FormEvent) => {
    e.preventDefault();
  ...
  return (
    <main className="min-h-screen bg-white text-black font-sans selection:bg-zinc-700 selection:text-white relative">
      ...
      {/* POP-UP DE BIENVENIDA (MARKETING) */}
      {showPopup && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 animate-in fade-in duration-500">
          ...
          <div className="bg-white w-full max-w-md p-10 relative z-10 shadow-2xl border-4 border-black">
            <button onClick={() => setShowPopup(false)} className="absolute top-4 right-4 text-zinc-400 hover:text-black font-black uppercase text-[10px] tracking-widest">
              [ Cerrar ]
            </button>
            ...
            {!codeRevealed ? (
              <div className="text-center">
                ...
                <p className="text-xs font-bold text-zinc-500 uppercase tracking-widest mb-8 leading-relaxed">
                  Introduce tu email y desbloquea un <span className="text-black">10% de descuento</span> en tu primera compra.
                </p>
                <form onSubmit={handleRevealCode} className="space-y-4">
                  ...
                  />
                  <button type="submit" className="w-full bg-black text-white py-4 font-black uppercase tracking-widest hover:bg-zinc-800 transition-all">
                    Revelar Código Secreto
                  </button>
                </form>
                <button onClick={() => setShowPopup(false)} className="mt-4 text-[9px] text-zinc-300 font-bold uppercase tracking-[0.2em] hover:text-zinc-500">
              ...
              <div className="text-center animate-in zoom-in-95">
                ...
                <p className="text-xs text-zinc-400 font-bold uppercase tracking-widest mb-6">Cópialo y úsalo en el carrito</p>
      ...
      {/* CATÁLOGO (Sin mencionar el código) */}
        ...
        <>
          ...
          <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white z-[70] shadow-2xl p-8 flex flex-col animate-in slide-in-from-right duration-300">
            ...
            <div className="border-t pt-6 bg-zinc-50 -mx-8 px-8 pb-6">
              ...
              {discount > 0 && <p className="text-[9px] text-green-600 font-bold uppercase mt-2 tracking-widest">Descuento aplicado con éxito</p>}
            </div>
