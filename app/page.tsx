...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white text-black font-sans selection:bg-zinc-700 selection:text-white relative">
      ...
      {/* SECCIÓN DE FILTRACIÓN / HYPE */}
      <section className="bg-zinc-50 py-24 px-6 text-center border-y border-zinc-100 relative overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full opacity-5 pointer-events-none" style={{ backgroundImage: 'radial-gradient(circle at center, black 1px, transparent 1px)', backgroundSize: '24px 24px' }}></div>
        <div className="max-w-3xl mx-auto flex flex-col items-center relative z-10">
          <span className="text-[10px] font-black tracking-[0.5em] uppercase text-zinc-400 mb-6 flex items-center gap-4">
          ...
          <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter italic mb-8">
            El verano exige una <br/>nueva estética.
          </h2>
          <p className="text-sm md:text-base font-medium text-zinc-500 uppercase tracking-widest leading-relaxed mb-12">
            No buscabas una prenda más, buscabas <span className="text-black font-black">la pieza definitiva</span> de la temporada. Aquí tienes una filtración exclusiva del Drop. Prepárate para algo muy grande.
          </p>
          <div className="text-[10px] font-black uppercase tracking-widest text-black border-2 border-black px-6 py-2 rotate-[-2deg] opacity-70">
            [ ACCESS RESTRICTED ]
          </div>
        </div>
      </section>
